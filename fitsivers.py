...
# 50 on 2026-08-24 -- see WHAT Nrep BUYS YOU below; the cost is ~19 min instead
# of ~4 min for a Sivers fit). NREP=50 reproduces every output file written
...
def _fitworld_one(seed):
    ...
    Min.strategy=1
    Min.migrad()
    row = [Min.values['Nu'],Min.values['au'],Min.values['bu'],Min.values['cu'],\
